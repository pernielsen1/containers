...
/** Entry point, reconnect loop. Port of xv5's router/main.py. */
public final class RouterMain {
    ...
    public static void run(RouterConfig cfg, StopEvent stopEvent, Stats statsIn) throws Exception {
        ...
        // xv5's ordering requirement (there, a late basicConfig call is a no-op once the root
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // thread left), so unlike xv5 (where every thread genuinely is a daemon thread and
