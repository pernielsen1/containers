 ...
 * already applied to crypto. Port of xv5's shared/command_server.py.
 */
public final class CommandServer {
    ...
    /**
     * Registers a custom route, mirroring xv5's {@code CommandServer.register(path, methods,
    ...
    public void start() {
        // Daemon threads for every request-handling thread, matching xv5's design intent - but
