# resilience
## every actor needs to understand silence
plan for this using skill router
we have a pattern where upstream host will connect or accept connection and ensure there is traffic due to the 0800 messages.
